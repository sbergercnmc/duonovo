...
The user can optionally provide a vector of coordinates of variants of interest. In this case, only these variants will be tested for de novo status (assuming they are heterozygous in the proband and absent in the parent). If specific variants of interest are not provided, then duoNovo tests all variants heterozygous in the proband and absent in the parent.
...
- **test_reference_allele**: Logical value specifying if positions where the proband is heterozygous and the parent is homozygous for the variant allele should also be tested.
